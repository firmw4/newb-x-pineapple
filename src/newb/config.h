...
#define NL_CONSTRAST      0.842
#define NL_EXPOSURE       1.723
#define NL_SATURATION     1.426
...
#define NL_NIGHT_BRIGHTNESS	    0.09 // 0.0 dark ~ 2.0 bright
...
#define NL_MIST_DENSITY         2.22    // 0.0 no mist ~ 1.0 misty
...
#define NL_NIGHT_ZENITH_COL  vec3(0.01,0.008,0.04)
#define NL_NIGHT_HORIZON_COL vec3(0.01,0.065,0.32)

#define NL_DAWN_EDGE_COL     vec3(1.5,0.52,0.43)
#define NL_DAWN_HORIZON_COL  vec3(1.4,0.817,0.2)
#define NL_DAWN_ZENITH_COL	 vec3(0.13,0.31,0.9)
...
#define NL_AURORA_COL3 vec3(0.2,0.9,0.5)

/* Chunk loading slide in animation */
//#define NL_CHUNK_LOAD_ANIM    100.0 // [toggle] -600.0 fall from top ~ 600.0 rise from bottom

/* Sun/Moon */
#define NL_SUNMOON_ANGLE        43.0    // [toggle] 0.0 no tilt - 90.0 tilt of 90 degrees
...
#define NL_DARKEN_PLANT_BOTTOM      1.2     // darken at bottom (increase value to make darker)
//#define NL_3DNOISE
