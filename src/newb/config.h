...
#define NL_CONSTRAST     0.654
#define NL_EXPOSURE      0.823
...
#define NL_DAY_ZENITH_COL    vec3(0.163, 0.34, 1.0)
#define NL_DAY_HORIZON_COL   vec3(0.67, 0.67, 0.98)

#define NL_NIGHT_ZENITH_COL  vec3(0.0, 0.001, 0.002)
#define NL_NIGHT_HORIZON_COL vec3(0.003, 0.08, 0.35)
...
#define NL_END_ZENITH_COL    vec3(0.004, 0.0, 0.01)
#define NL_END_HORIZON_COL   vec3(0.3, 0.008, 0.52)
...
#define NL_DARKEN_PLANT_BOTTOM      1.4     // darken at bottom (increase value to make darker)
//#define NL_3DNOISE
