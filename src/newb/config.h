...
#define NL_CONSTRAST		    0.852
#define NL_EXPOSURE			    1.303
#define NL_SATURATION 		    1.516

//#define NL_TINT 		        vec3(1.0,0.75,0.5)

/* Terrain lighting */
#define NL_SUN_INTENSITY		2.25 // 0.5 weak ~ 5.0 bright
#define NL_TORCH_INTENSITY		0.95 // 0.5 weak ~ 3.0 bright
#define NL_NIGHT_BRIGHTNESS	    0.12 // 0.0 dark ~ 2.0 bright
#define NL_CAVE_BRIGHTNESS		1.54 // 0.0 dark ~ 2.0 bright
...
#define NL_NOON_SUN_COL		    vec3(1.302,0.8,0.6)
#define NL_NIGHT_SUN_COL	    vec3(0.6,0.67,0.92)

/* Ambient light on terrain (light that is added everywhere) */
#define NL_NETHER_AMBIENT       vec3(0.692,0.527,0.712)//vec3(3.0,2.16,1.89)
#define NL_END_AMBIENT          vec3(0.853,0.594,1.178)//vec3(1.98,1.25,2.3)

/* Torch colors */
#define NL_OVERWORLD_TORCH_COL		vec3(0.85,0.42,0.16)
#define NL_UNDERWATER_TORCH_COL	    vec3(0.039,0.7,0.41)
#define NL_NETHER_TORCH_COL		    vec3(1.0,0.54,0.21)
#define NL_END_TORCH_COL		    vec3(0.31,0.09,0.8)

/* Fog */
#define NL_FOG_TYPE             2       // 0:no fog, 1:vanilla, 2:smoother vanilla
#define NL_MIST_DENSITY         3.22    // 0.0 no mist ~ 1.0 misty
#define NL_RAIN_MIST_OPACITY    0.3     // [toggle] 0.04 very subtle ~ 0.5 thick mist blow

/* Sky colors - zenith=top, horizon=bottom */
#define NL_DAY_ZENITH_COL    vec3(0.23,0.41,1.0)
#define NL_DAY_HORIZON_COL   vec3(0.8,0.81,0.98)

#define NL_NIGHT_ZENITH_COL  vec3(0.0,0.021,0.08)
#define NL_NIGHT_HORIZON_COL vec3(0.0,0.043,0.21)

#define NL_DAWN_EDGE_COL     vec3(1.3,0.52,0.13)
#define NL_DAWN_HORIZON_COL  vec3(0.7,0.417,0.3)
#define NL_DAWN_ZENITH_COL	 vec3(0.23,0.41,1.0)

#define NL_RAIN_ZENITH_COL   vec3(0.15,0.201,0.28)
#define NL_RAIN_HORIZON_COL  vec3(0.37,0.413,0.58)

#define NL_END_ZENITH_COL    vec3(0.02,0.0,0.1)
#define NL_END_HORIZON_COL   vec3(0.3,0.21,0.41)
...
/* Water */
#define NL_WATER_TRANSPARENCY           0.944    // 0.0 transparent ~ 1.0 normal
...
#define NL_WATER_TINT                   vec3(0.304,0.909,0.603)

/* Underwater */
#define NL_UNDERWATER_BRIGHTNESS    2.8 // 0.0 dark ~ 3.0 bright
...
#define NL_UNDERWATER_TINT          vec3(0.2,1.0,0.8) // fog tint color when underwater
...
#define NL_CLOUD2_VELOCIY				1.6     // 0.0 static ~ 4.0 very fast
...
#define NL_AURORA_COL2 vec3(1.0,0.1,1.0)

/* Chunk loading slide in animation */
//#define NL_CHUNK_LOAD_ANIM    100.0 // [toggle] -600.0 fall from top ~ 600.0 rise from bottom

/* Sun/Moon */
#define NL_SUNMOON_ANGLE        25.0    // [toggle] 0.0 no tilt - 90.0 tilt of 90 degrees
